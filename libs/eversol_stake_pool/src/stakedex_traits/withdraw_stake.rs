...
pub struct WithdrawStakeQuoteIter<'a> {
    pool: &'a EversolStakePoolStakedex,
    withdraw_amount: u64,
...
impl<'a> WithdrawStakeQuoteIter<'a> {
    ...
    fn next_preferred(&self) -> Option<(WithdrawStakeQuote, WithdrawStakeQuoteIterState)> {
        // unwrap-safety: WithdrawStakeQuoteIter is only created by EversolStakePoolStakedex::withdraw_stake_quote_iter()
...
impl WithdrawStakeIter for EversolStakePoolStakedex {
...
impl WithdrawStakeBase for EversolStakePoolStakedex {
